...
public class Metrics {
    ...
    private static final MqMetricRegistry INSTANCE;

    static {
        ServiceLoader<MqMetricRegistry> registries = ServiceLoader.load(MqMetricRegistry.class);
        MqMetricRegistry instance = null;
        for (MqMetricRegistry registry : registries) {
            instance = registry;
            break;
        }
        if (instance == null) {
    ...
    public static MqCounter counter(String name, String[] tags, String[] values) {
        return INSTANCE.newCounter(name, tags, values);
    }

    public static MqCounter counter(String name) {
        return INSTANCE.newCounter(name, EMPTY, EMPTY);
    }

    public static MqMeter meter(String name, String[] tags, String[] values) {
        return INSTANCE.newMeter(name, tags, values);
    }

    public static MqMeter meter(String name) {
        return INSTANCE.newMeter(name, EMPTY, EMPTY);
    }

    public static MqTimer timer(String name, String[] tags, String[] values) {
        return INSTANCE.newTimer(name, tags, values);
    }

    public static MqTimer timer(String name) {
